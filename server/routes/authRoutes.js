...
const { registerUser, loginUser, googleLogin, updateProfile, refreshToken, logoutUser, logoutAll, getMe, forgotPassword, resetPassword } = require('../controllers/authController');
