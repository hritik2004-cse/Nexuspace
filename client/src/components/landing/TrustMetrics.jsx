...
export default function TrustMetrics() {
  return (
    <section className="relative z-10 py-16 border-y border-white/5 bg-[#030014]/80 backdrop-blur-md">
      <div className="max-w-7xl mx-auto px-6">
        <div className="flex flex-col md:flex-row items-center justify-between gap-10">
          
          <div className="text-center md:text-left">
            <h3 className="text-3xl font-black text-white mb-2">Enterprise Grade.</h3>
            <p className="text-slate-500 font-medium">Metrics that back our infrastructure.</p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-12 lg:gap-24">
            <div className="flex flex-col items-center">
               ...
               <span className="text-sm font-bold tracking-widest uppercase text-slate-500">Uptime SLA</span>
            </div>
            ...
            <div className="flex flex-col items-center">
               ...
               <span className="text-sm font-bold tracking-widest uppercase text-slate-500">Global Latency</span>
            </div>
            ...
            <div className="flex flex-col items-center">
               ...
               <span className="text-sm font-bold tracking-widest uppercase text-slate-500">Messages / Day</span>
            </div>
          </div>
